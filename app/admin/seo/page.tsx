      ...
      {tab === 'meta' && (
        <div>
          ...
          <AdminFormModal isOpen={seoModalOpen} title={seoEditing ? 'Edit Page Meta Tags' : 'Add Page Meta Tags'} onSubmit={handleSeoSubmit} onClose={() => setSeoModalOpen(false)} loading={seoSaving}>
            ...
            <FormField label="Social Share Image" name="og_image_url" value={seoForm.og_image_url} onChange={updateSeoForm} uploadFolder="seo" help="Upload or paste URL. Best size for shares: 1200×630px." preview="Social media card image" />
