...
export default function AdminPagesPage() {
  ...
  const pageUrl = (p: CmsPage) => {
    const base = p.site_id === 'alpenglow' ? 'https://aspenalpenglow.com' : 'https://richvalleyadventures.com'
    return `${base}/${p.slug}`
  }
              ...
              {(editing.meta_title || editing.title) && (
                <div className="border border-slate-200 rounded-xl p-4 bg-slate-50">
                  ...
                  <p className="text-[#006621] text-xs">
                    {editing.site_id === 'alpenglow' ? 'aspenalpenglow.com' : 'richvalleyadventures.com'}/{editing.slug || '…'}
                  </p>
