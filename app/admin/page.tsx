        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">aspenalpenglowlimosine.com</p>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-4 mb-5">
            <div className="text-center">
          ...
          <a href="https://aspenalpenglowlimosine.com" target="_blank" rel="noopener noreferrer" className="text-xs text-blue-700 font-medium hover:text-blue-800 inline-flex items-center gap-1">
            Visit Site
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
          </a>
        </div>
