...
async function seed() {
  ...
  // Popular destinations (AAL homepage + /destinations) — shared definition in lib/seed-destinations-data.ts
  await seedIfEmpty('destinations', [...STOCK_ALPENGLOW_DESTINATIONS])
