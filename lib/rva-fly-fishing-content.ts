import type { ServiceContent } from '@/lib/pages'

export const flyFishingPageTitle = 'Guided Fly Fishing in Aspen & the Roaring Fork Valley'

export const flyFishingServiceContent: ServiceContent = {
  hero_title: flyFishingPageTitle,
  hero_subtitle: "Cast on Colorado's Gold Medal Waters with Expert Local Guides",
  intro: `The Roaring Fork Valley is one of the most storied fly fishing destinations in the American West. We guide the Roaring Fork River, Frying Pan River, Colorado River near Glenwood Springs, the Gunnison River on float trips, and exclusive private water — including pond and alpine spring settings, high mountain lakes, and the Old Town Basalt Private Ranch on the Roaring Fork — for anglers who want uncrowded water and a tailored experience.

Rich Valley Adventures has been guiding these waters since 2012. Our guides grew up fishing these drainages and know every productive run, seam, and riffle across seasons. Whether you're picking up a fly rod for the first time or you're a seasoned angler chasing your personal best, we tailor every trip to your experience level and goals.

We offer half-day and full-day guided trips from May through October on our wading fisheries, and dedicated float trips on the Gunnison with our in-house boat captain. All gear is provided — premium fly rods, reels, waders, wading boots, and a full fly selection matched to current hatch conditions. Our catch-and-release philosophy protects these waters for generations of anglers to come.`,
  h2_sections: [
    {
...
The Frying Pan demands technical precision: long leaders, small flies, and delicate presentations. Our guides excel at teaching the nuances of tailwater nymphing and the art of fishing size-22 midge clusters to selective risers. This river rewards patience and skill — and the payoff is the fish of a lifetime.`,
    ...
    {
      title: 'Gunnison River — Big Water, Trophy Trout',
      content: `The Gunnison is one of the most celebrated fisheries in North America — big water, dramatic canyon scenery, and a legitimate shot at large wild trout. From Aspen, plan on roughly two and a half hours to the float sections we fish; this is not a quick wade-upstream outing — it's a full-day experience on moving water that demands a boat.

Float trips are the right tool here: the river's volume, structure, and depth are best approached from the oars with a skilled captain. Alex Macintyre serves as Rich Valley Adventures' boat captain for these Gunnison expeditions, putting you in position for quality drifts through some of the West's most spectacular canyon water. Expect big-sky views, technical fishing, and the kind of wild trout that make the drive worth every mile.`,
    },
    {
      title: 'Private Water Access — Exclusive Fishing Experiences',
      content: `Some guests want solitude, certainty, or a softer introduction to the sport. Our private water program delivers: no public crowds, carefully managed access, and settings chosen for the experience you want — whether that's a family-friendly pond on an alpine spring with reliable action for beginners, a hike-in day at high mountain lakes, or the Old Town Basalt Private Ranch on the Roaring Fork for exclusive river access near Basalt.

These are not public-access points — they're relationships we've built over years of guiding in the valley. That exclusivity means less pressure on the fish, more time on the water for you, and the option to prioritize a relaxed, high-success day when conditions or confidence matter most. When you want intimacy, discretion, or a premium experience away from the beaten path, we build your day around private water.`,
    },
  ],
  features: [
    {
      title: 'Rivers & waters we fish',
      description:
        'Roaring Fork River, Frying Pan River, Colorado River (near Glenwood Springs), Gunnison River float trips, and private water access — including pond, alpine spring, ranch water, and high mountain lakes.',
    },
    {
    ...
    {
      title: 'Small Groups (Max 4)',
      description:
        'Intimate guide-to-angler ratios mean more instruction, better water, and a more personal experience.',
    },
    {
      title: 'Half-Day & Full-Day Options',
      description:
        'Choose a 4-hour morning or afternoon session, or go all-in with a full-day trip including riverside lunch where applicable.',
    },
    {
      title: 'Licenses, lunch & logistics',
      description:
        'Fishing license support, streamside lunch on full-day trips, professional photos of your fish, and transportation coordinated with Aspen Alpenglow Limousine when needed. Up to four anglers per guide on wading trips.',
    },
    {
      title: 'Catch & Release',
      description:
  ...
  faqs: [
    {
      question: 'Do I need a Colorado fishing license?',
      answer:
    ...
    {
      question: 'What time of year is best for fly fishing near Aspen?',
      answer:
    ...
    {
      question: 'Can beginners go fly fishing with you?',
      answer:
