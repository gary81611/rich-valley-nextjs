...
const FOOTER_ADVENTURES = [
  { title: 'Fly Fishing', href: '/fly-fishing' },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm text-center md:text-left">
            © {new Date().getFullYear()} Rich Valley Adventures. All rights reserved. | {rvaData.location}
            {' '}|{' '}
            <a
              href="https://www.adaptedsolutionsco.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/50 hover:text-rva-copper-light transition-colors underline-offset-2 hover:underline"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <a href={rvaData.social.instagramGuide} target="_blank" rel="noopener noreferrer" aria-label="Our guide Kit on Instagram" className="text-white/40 hover:text-rva-copper-light text-sm transition-colors self-center">
              @kit_rvaspen
            </a>
          </div>
        </div>
