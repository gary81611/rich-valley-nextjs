...
export default function BookingPlaceholder({ accentColor, accentHover, phone, phoneHref, variant }: BookingPlaceholderProps) {
  ...
  const serviceOptions = variant === 'rva'
    ? ['Fly Fishing', 'Paddle Boarding', 'Mountain Biking', 'Trail Hiking', 'Chauffeur Guided Tour', 'Elevated Camping', 'Snowshoeing', 'Cross-Country Skiing', 'Ice Fishing', 'Winter Escalade Tour']
